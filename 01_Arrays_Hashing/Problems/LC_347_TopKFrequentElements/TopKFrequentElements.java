...
public class TopKFrequentElements {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nSolution4 (Min Heap with Size K) Test Results:");
        System.out.println("Test 1: " + Arrays.toString(TopKFrequentElements4.topKFrequent(nums1, k1)));
        System.out.println("Test 2: " + Arrays.toString(TopKFrequentElements4.topKFrequent(nums2, k2)));
        System.out.println("Test 3: " + Arrays.toString(TopKFrequentElements4.topKFrequent(nums3, k3)));
        System.out.println("Test 4: " + Arrays.toString(TopKFrequentElements4.topKFrequent(nums4, k4)));
    }
}
...
/**
 * Solution 4: Min Heap with Size K (Space Optimized)
 * Time Complexity: O(n log k) where n is the number of elements and k is the input parameter
 * Space Complexity: O(n + k) for HashMap and heap storage
 */
